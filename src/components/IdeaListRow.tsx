...
export function IdeaListRow({ idea, rank }: IdeaListRowProps) {
  return (
    <Link
      ...
      className="group flex items-center gap-4 px-4 py-5 border-b border-zinc-800/50 transition-colors hover:bg-zinc-800/30"
    >
      {/* Icon */}
      ...
      <div className="flex-1 min-w-0">
        <h3 className="font-semibold text-zinc-100 group-hover:text-orange-400 transition-colors">
          {idea.title}
        </h3>
