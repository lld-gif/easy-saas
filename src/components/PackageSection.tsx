      ...
      <div className="mt-8">
        ...
        <div className="space-y-6">
          {[
            ...
            <details key={section.title} className="border border-border rounded-xl overflow-hidden" open>
  ...
  return (
    <div className="mt-8">
      ...
      <div className="border border-dashed border-input rounded-xl p-8 text-center bg-card">
        <p className="text-foreground/80 mb-1">Get a personalized Tech Spec, Brand Kit, and Launch Checklist</p>
        <p className="text-xs text-muted-foreground mb-4">Generated by AI in ~10 seconds. Cached forever.</p>
