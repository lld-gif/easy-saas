 ...
 *
 * Called by Vercel Cron every 6 hours (at :17 past the hour). Inspects
 * the per-platform pipeline health view and fires a single email digest
 * if any platform is in `degraded`, `stale`, or `broken` state.
 *
